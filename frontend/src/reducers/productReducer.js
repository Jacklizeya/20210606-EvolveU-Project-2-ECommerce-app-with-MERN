import {
    ...
    PRODUCT_UPDATE_INSTOCK_REQUEST, PRODUCT_UPDATE_INSTOCK_SUCCESS, PRODUCT_UPDATE_INSTOCK_FAIL, PRODUCT_UPDATE_INSTOCK_RESET,
...
export const productUpdateInStockReducer = (state = { product: {} }, action) => {
    switch (action.type) {
        case PRODUCT_UPDATE_INSTOCK_REQUEST:
            return { loading: true };
        case PRODUCT_UPDATE_INSTOCK_SUCCESS:
            return { loading: false, success: true, product: action.payload };
        case PRODUCT_UPDATE_INSTOCK_FAIL:
            return { loading: false, error: action.payload };
        case PRODUCT_UPDATE_INSTOCK_RESET:
            return { product: {} };
        default: return state;
    }
}

// the return function will set what that state is going to be looklike
// Reducer state: {product: []}
// Reducer state: {product: action.payload, loading: true}