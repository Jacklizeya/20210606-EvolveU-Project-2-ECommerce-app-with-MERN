            ...
            <Table striped bordered hover responsive className="table-sm">
                ...
                <tbody>
                    ...
                    <tr key={order._id}>
                        ...
                        <td> {order.isPaid? (order.paidAt.substring(0, 10)):(<i className = "fas fa-times" style={{color: "black"}}></i>)} </td>
                        <td> {order.isDelivered? (order.deliveredAt.substring(0, 10)):(<i className = "fas fa-times" style={{color: "black"}}></i>)} </td>    
                        <td>
